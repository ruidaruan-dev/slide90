...
- Slide90 brand, portable Agent Skill, and design tokens.
- Eight executive-layout patterns.
- Fast Loop batch specification, fixed layout coordinates, and structural validation.
- Cross-platform installer and ZIP packaging.
- Synthetic visual examples and baseline evaluations.
...
- Stable cross-platform skill contract.
- Public benchmark with human-scored examples.
- Community layout registry.
- Documented compatibility across major agent runtimes.
