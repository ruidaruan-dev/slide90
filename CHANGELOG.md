...
- Portable `build-executive-report-slides` Agent Skill under the Slide90 project.
- Eight-layout routing library.
...
- Repository validation, tests, and release packaging.
